...
router.post("/reviews", controller.reviews_post); //only verified purchases
...
router.post("/orderhistory", auth.verify_Auth, controller.orderHistory_create); //only by the user or admins - Logic includes verifying the purchase before adding
